...
export const StudentDashboard: React.FC<Props> = ({ user, dailyStudySeconds, onSubjectSelect, onRedeemSuccess, settings, onStartWeeklyTest }) => {
  ...
  return (
    <div>
        ...
        <div className={`grid ${isGameEnabled ? 'grid-cols-9' : 'grid-cols-8'} gap-1 bg-white p-2 rounded-xl border border-slate-200 shadow-sm mb-8 sticky top-20 z-20 overflow-x-auto`}>
            ...
            <button onClick={() => setActiveTab('VIDEOS')} className={`flex flex-col items-center justify-center p-2 rounded-lg transition-all min-w-[60px] ${activeTab === 'VIDEOS' ? 'bg-red-50 text-red-600' : 'text-slate-400 hover:bg-slate-50'}`}><Play size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Videos</span></button>
        ...
        <div className="min-h-[400px]">
            ...
            {activeTab === 'VIDEOS' && <VideoLibrary user={user} />}
